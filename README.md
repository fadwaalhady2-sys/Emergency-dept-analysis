...
[5/23/2026 5:24 PM] N.N Al: # Emergency Department Data Analysis (MIMIC-IV)
...
## 📊 Project Visualizations
*(Note: Please ensure the image files are uploaded to the main repository)*

- Average Stay Duration by Diagnosis (File: download (3).png)
- Patient Load vs. Time of Day (File: download (4).png)
- Distribution of Heart Rate by Patient Disposition (File: download (5).png)
- Correlation Heatmap: Duration vs. Heart Rate (File: download (6).png)
